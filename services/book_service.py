...
class BookService:
    ...
    async def get_books(self, status=None, author=None, sort_by=None, sort_order='asc', limit=10, offset=0):
        return await self.repo.get_books(status, author, sort_by, sort_order, limit, offset)
