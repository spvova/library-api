...
class BookService:
    ...
    async def get_books(self, status=None, author=None, sort_by=None, sort_order='asc', cursor=None, limit=10):
        return await self.repo.get_books(status, author, sort_by, sort_order, cursor, limit)
